...
static volatile EBIKE_MODE_T ebike_mode = EBIKE_MODE_LEGAL;
...
EBIKE_MODE_T assist_code_to_ebike_mode(uint8_t assist_code) {
	switch (assist_code) {
		case PAS_LEVEL_4: return EBIKE_MODE_RPM_LIMIT;
		case PAS_LEVEL_6: return EBIKE_MODE_UNRESTRICTED;
		case PAS_LEVEL_9: return EBIKE_MODE_UNRESTRICTED_PLUS;
		default: return EBIKE_MODE_LEGAL;
	}
}
